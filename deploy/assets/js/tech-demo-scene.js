...
export class TechDemoScene {
    constructor(container) {
        ...
        console.log("Tech Demo Scene Initialized - v2.809-enable-card-scrolling-restore-card-scrollbar-suppress-json-leak-calm-listening-stop-standby-loop-visitor-id-logging-silent-id-debug-async-debug-async-debug (Voice Sync + Debug)");
