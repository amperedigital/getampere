...
export class TechDemoScene {
    constructor(container) {
        ...
        console.log("Tech Demo Scene Initialized - v2.808-restore-card-scrollbar-suppress-json-leak-calm-listening-stop-standby-loop-visitor-id-logging-silent-id-debug-async-debug-async-debug (Voice Sync + Debug)");
