// v3.214: Console pipe moved to ai-chat.js (shared by both index.html and tech-demo.html)


// global.js - Initialize Lenis and other global page setup
(function () {
    console.log('[Ampere Global] memory-api Loaded');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initial check
    setTimeout(() => {
        console.log("[Global] Initializing memory-api...");
        checkNavTheme();
    }, 100);
});
