const initModal = () => {
  ...
  function wrapModalContent(contentEl) {
    ...
    modalShell.className = "fixed inset-0 z-[99999] flex w-screen h-screen items-start md:items-center justify-center px-4 sm:px-6 md:px-0 py-6 md:py-8 pt-4 md:pt-0 transition-all duration-500 ease-out opacity-0 translate-y-4 scale-[0.98] pointer-events-none";
    ...
    wrapper.className = "md:rounded-3xl overflow-visible w-full sm:w-11/12 md:w-[90vw] lg:w-[75vw] xl:w-[100vw] sm:max-w-3xl md:max-w-[1200px] h-full mt-[7.5rem] md:mt-[7rem] pointer-events-auto rounded-none mx-auto pb-8 relative z-[9998]";
